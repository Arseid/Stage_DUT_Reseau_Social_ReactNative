...
export function ProfileScreen({navigation}){
  ...
  const {userInfo,logout,modify,modifyProfilePicture,backgroundPicture,followersList,followingList,unfollowUser,removeFollower,retrievePosts,showUserProfiles} = useContext(AuthContext);
